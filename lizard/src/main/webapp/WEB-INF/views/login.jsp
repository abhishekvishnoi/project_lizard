...
<script type="text/javascript" src="../assets/wect/js/bootstrap.js.js"></script>
			...
			<div class="col-md-4 col-md-offset-7">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form:form commandName="userForm" action="./login.do"
					...
					<div class="panel-footer">
						Not Registred? <a href="./RegisterUser.do">Register
							here</a>
					</div>
				</div>
			</div>
